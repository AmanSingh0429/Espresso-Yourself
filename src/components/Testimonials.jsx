  ...
  const testimonials = [
    {
      ...
      text: "Cafe has become my second office. The oat vanilla latte is perfection, and the staff always remembers my name. Best coffee in town!",
      rating: 5,
    ...
    },
    {
      ...
      text: "The chai latte keeps me going through my workday. Cafe has become an essential part of my business routine.",
      rating: 5,
      drink: "Chai Latte"
    }
  ]
    ...
    <section className="bg-[#f6efe6] py-20">
      <div className="mx-auto max-w-7xl px-6 sm:px-10 lg:px-12">
        ...
        <div className="text-center">
          ...
          <h2 className="mt-3 text-3xl tracking-tight text-primary sm:text-4xl">
            Loved by our community
          </h2>
          <p className="mx-auto mt-4 max-w-2xl text-lg leading-8 text-[#5f4636]">
            Don't just take our word for it — here's what our regulars have to say about their Cafe experience.
          </p>
        </div>
        ...
        <div className="mt-12 flex flex-wrap items-center justify-center gap-8 rounded-3xl bg-white p-8 shadow-[0_12px_30px_rgba(84,50,30,0.06)]">
          <div className="text-center">
            ...
            <p className="mt-2 text-3xl font-bold text-primary"><Counter target={4.9} /></p>
            <p className="text-sm text-[#6f5544]">Based on 1,284 reviews</p>
          </div>
          <div className="h-12 w-px bg-[#e6d6c5] max-md:hidden"></div>
          <div className="text-center">
            <p className="text-3xl font-bold text-primary"><Counter target={7} />+</p>
            <p className="text-sm text-[#6f5544]">Years serving the community</p>
          </div>
          <div className="h-12 w-px bg-[#e6d6c5] max-md:hidden"></div>
          <div className="text-center">
            <p className="text-3xl font-bold text-primary"><Counter target={15} />+</p>
          ...
          <div className="grid gap-8 md:grid-cols-[auto,1fr] md:items-center">
            ...
            <div className="text-center md:text-left">
              <p className="text-xl font-medium leading-relaxed italic md:text-2xl">
                "Cafe Coffee isn't just a coffee shop, it's the heart of our neighborhood.
